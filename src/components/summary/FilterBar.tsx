    ...
    <div className="grid grid-cols-1 gap-3 mb-6 rounded-lg border border-slate-200 bg-white p-4 shadow-sm lg:grid-cols-[minmax(260px,1fr)_160px_160px_150px_auto_auto] lg:items-center">
      <div className="relative min-w-0">
        ...
        <input
          ...
          className="w-full rounded-md border border-slate-300 bg-white py-2 pl-10 pr-4 text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-300 focus:border-slate-400"
        />
      </div>
      ...
      <select
        ...
        className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-300 focus:border-slate-400"
      >
      ...
      {hasFilters && (
        <button
          ...
          className="flex items-center justify-center gap-1 whitespace-nowrap rounded-md px-3 py-2 text-sm text-slate-500 hover:bg-slate-100 hover:text-slate-700"
        >
          <X className="w-4 h-4" />
          清除筛选
        </button>
