...
const REPO_COMMUNITY_MAP: Record<string, string> = {
  ...
  'kpex': 'HPCKit',
  'brotli4j': 'BoostKit', 'lowlatencylib': 'BoostKit', 'pandas': 'BoostKit',
  'snappy': 'BoostKit', 'vllm-router': 'BoostKit', 'zlib': 'BoostKit', 'zstd': 'BoostKit',
  'opplugin': 'PyTorch', 'torchnpu': 'PyTorch',
